...
exports.login = async (req, res) => {
  ...
  try {
    ...
    console.log("statesAssigned: ", statesAssigned);
...
//     const token = jwt.sign({ id: user.system_id, Role: roleNames, modules: modulesList, }, process.env.JWT_SECRET, { expiresIn: process.env.JWT_EXPIRES_IN });
